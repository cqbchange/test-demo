<!--
 * @Descripttion: 小程序推送日志
 * @version: 1.0
 * @Author: Dulei 
 * @Date: 2021-01-15 16:52:43
 * @LastEditors: WangChuan
 * @LastEditTime: 2021-01-30 15:40:48
-->
<template>
  <div>
    <div class="topBox">
      <el-form :inline="true" ref="dataForm" class="demo-form-inline">
        <el-form-item style="flex:1;">
          <el-button size="medium"  icon="el-icon-refresh" type="primary" class="my-blue-btn" @click="refresh">刷新</el-button>
        </el-form-item>
    ...
    <fix-table border v-loading="loading" element-loading-spinner="el-icon-loading"
            ...
            header-row-class-name="my-table-header" class="my-table" :data="list">
