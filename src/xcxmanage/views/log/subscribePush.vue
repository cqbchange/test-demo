 ...
 * @LastEditTime: 2021-03-06 16:36:34
-->
<template>
    <div>
        <div class="topBox">
        ...
        <div class="table_box">
            <fix-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" :data="list" height="73.7vh" border style="width: 100%" header-row-class-name="my-table-header" class="my-table">
                ...
                <el-table-column prop="name" label="小程序" align="center"></el-table-column>
...
<script>
    export default {
        ...
        methods: {
            ...
            loadData () {
            this.loading = true
            this.getRequest('/XcxSubscribePush/getLog', {
            ...
            del (data) {
                this.$confirm('此操作将永久删除该项, 是否继续?', '提示', {
                    ...
                    this.postRequest('/XcxSubscribePush/sendDelete', data).then(data => {
                        if (data.code == 200) {
